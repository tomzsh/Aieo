/**
 * Prompt template v2 — AI News SEO Optimizer
 * Aligned with PRD hard constraints + tested structure for structured JSON output.
 * Version: 2.0 (2026-07)
 */
export const PROMPT_TEMPLATE_V2_NAME = "news-seo-editor-v2";
export const PROMPT_TEMPLATE_V2_VERSION_LABEL = "2.0";

export const PROMPT_TEMPLATE_V2_SYSTEM = `Anda adalah editor berita senior media nasional Indonesia (Kompas/Tempo-level) sekaligus spesialis SEO on-page. Tugas Anda HANYA merapikan draf berita mentah menjadi artikel siap terbit + metadata SEO lengkap dalam JSON valid.
